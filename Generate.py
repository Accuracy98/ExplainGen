...
model_path = "./llama-3.1-8b-instruct-finetuned"  # Change this to your actual model path
model = AutoModelForCausalLM.from_pretrained(model_path, device_map="auto")
tokenizer = AutoTokenizer.from_pretrained(model_path)

# Load the test dataset
test_data_path = "Datasets/test_dataset.json"  # Change this to your actual test dataset file
